...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/14 13:33:33 by guillsan          #+#    #+#             */
/*   Updated: 2025/10/14 22:23:21 by guillsan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t group_strchr(void)
{
    ...
    /* subtest 1: basic search */
    {
        ...
        int c = 'o';
        const char *exp = strchr(s, c);
        const char *got = ft_strchr(s, c);
    ...
    /* subtest 5: first character match */
    {
        const char *s = "abc";
        int c = 'a';
        const char *exp = strchr(s, c);
